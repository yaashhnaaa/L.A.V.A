...
class LAVA:
    ...
    def greet(self):
        ...
        self.talk("I am LAVA Sir. Please tell me how may I help you")
    ...
    def No_result_found(self):
        self.talk("Sorry Sir, I didn't get that. Can you please say it again?")
    ...
    def yt_google_commands(self, command):
        ...
        if 'play' in command:
            ...
            self.talk("Sir, please tell me what you want to know on Wikipedia")
            wiki_query = self.take_Command()
            result = wikipedia.summary(wiki_query, sentences=2)
            print(result)
            self.talk(result)
        elif 'netflix' in command:
            self.talk("Sir, opening Netflix for you")
            webbrowser.open('https://www.netflix.com/')
        elif 'prime' in command:
            self.talk('Sir, opening Amazon prime video for you')
            webbrowser.open('https://www.primevideo.com/offers/nonprimehomepage/ref=dv_web_force_root')
        elif 'facebook' in command:
            self.talk("Sir, opening Facebook for you")
            webbrowser.open('https://www.facebook.com/')
        elif 'instagram' in command:
            self.talk("Sir, opening Instagram for you")
            webbrowser.open('https://www.instagram.com/')
        elif 'gmail' in command:
            self.talk("Sir, opening Gmail for you")
